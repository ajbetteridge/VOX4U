...
UVoxelLoaderComponent::UVoxelLoaderComponent()
...
#if WITH_EDITOR
void UVoxelLoaderComponent::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UVoxelLoaderComponent::SetVoxel(class UVoxelLoader* InVoxel, bool bForce /*= false*/)
{
...
const UVoxelLoader* UVoxelLoaderComponent::GetVoxel() const
{
	return Voxel;
}

void UVoxelLoaderComponent::InitVoxel()
{
...
void UVoxelLoaderComponent::AddVoxel()
{
...
void UVoxelLoaderComponent::ClearVoxel()
{
	for (int32 i = 0; i < Mesh.Num(); ++i) {
...
bool UVoxelLoaderComponent::IsUnbeheldVolume(const FIntVector& InVector) const
{
...
bool UVoxelLoaderComponent::GetVoxelTransform(const FIntVector& InVector, FTransform& OutVoxelTransform, bool bWorldSpace /*= false*/) const
{
...
FBoxSphereBounds UVoxelLoaderComponent::CalcBounds(const FTransform& LocalToWorld) const
{
...
const TArray<UInstancedStaticMeshComponent*>& UVoxelLoaderComponent::GetInstancedStaticMeshComponent() const
{
